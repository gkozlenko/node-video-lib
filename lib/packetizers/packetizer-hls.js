...
PacketizerHls.prototype.packetize = function() {
    return this._fragment.read().then(function() {
        return this._packFragment();
    }.bind(this));
};

PacketizerHls.prototype._packFragment = function() {
    var buffers = [];
    var buffersLength = 0;
    ...
    if (this._fragment.videoExtraData().length > 0) {
        this._videoExtraParser = new ExtraParserH264(this._fragment.videoExtraData());
    }
    if (this._fragment.audioExtraData().length > 0) {
        this._audioExtraParser = new ExtraParserAac(this._fragment.audioExtraData());
    }
    ...
    var samples = this._fragment.samples();
...
PacketizerHls.prototype._videoConfig = function() {
    var units = this._videoExtraParser.sps().concat(this._videoExtraParser.pps());
    var data = new Buffer(4 * units.length + units.reduce(function(size, unit) {
