            ...
            if (TYPE_SCRIPT === type) {
                ...
                if (AUDIO_FORMAT_AAC === soundFormat) {
                    ...
                    if (0 === packetType) {
                        ...
                        let extraParser = ExtraParserAac.parse(audioTrack.extraData);
                        audioTrack.codec = extraParser.codec();
                        pos += dataSize;
                        continue;
                    }
                }
                ...
                if (VIDEO_FORMAT_H264 === videoFormat) {
                    ...
                    if (0 === packetType) {
                        ...
                        let extraParser = ExtraParserH264.parse(videoTrack.extraData);
                        videoTrack.codec = extraParser.codec();
                        pos += dataSize;
                        continue;
                    }
                }
