...
class AtomMP4A extends Atom {
    ...
    build(buffer, offset) {
        ...
        // sample rate
        buffer.writeUInt32BE(this.sampleRate, offset + 32);
        // extra data
        buffer.writeUInt32BE(this.extraData.length + 4, offset + 38);
        buffer.write(Utils.ATOM_ESDS, offset + 42);
        this.extraData.copy(buffer, offset + 46, 4);
    }

    bufferSize() {
        return 42 + this.extraData.length;
    }
