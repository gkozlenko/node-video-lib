                        ...
                        switch (hdlrAtom.handlerType) {
                            case Utils.TRACK_TYPE_AUDIO: {
                                ...
                                if (audioAtom !== null) {
                                    ...
                                    extraParser = ExtraParserAac.parse(audioAtom.extraData);
                                }
                                break;
                            }
                            case Utils.TRACK_TYPE_VIDEO: {
                                ...
                                if (videoAtom !== null) {
                                    ...
                                    extraParser = ExtraParserH264.parse(videoAtom.extraData);
                                }
                                break;
                            }
                        }
