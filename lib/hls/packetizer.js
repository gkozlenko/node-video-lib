...
class Packetizer {
        ...
        for (let i = 0, l = this.fragment.samples.length; i < l; i++) {
            ...
            if (sample instanceof AudioSample) {
                ...
                do {
                    ...
                    // PTS_DTS
                    Packetizer._writeTime(payload, pos, resTime);
                    pos += 5;
                    Packetizer._writeTime(payload, pos, sampleTime);
                    pos += 5;
    ...
    _packAudioPayload(payload, sample, time) {
        ...
        // PTS_DTS
        Packetizer._writeTime(data, pos, time);
        pos += 5;
    ...
    static _writeTime(buffer, pos, time) {
