...
class Packetizer {
    ...
    constructor(fragment) {
        ...
        this._videoExtraParser = this._fragment.videoExtraData ? ExtraParserH264.parse(this._fragment.videoExtraData) : null;
        this._audioExtraParser = this._fragment.audioExtraData ? ExtraParserAac.parse(this._fragment.audioExtraData) : null;
    }
    ...
    _buildHeader() {
        ...
        // Audio data
        if (this._fragment.audioExtraData) {
            mapBuf[mapPos++] = 0x0f;
